package com.example.cryptocomparator
...
import com.example.cryptocomparator.databinding.ActivityCoinBinding
...
class CoinActivity : AppCompatActivity() {
    ...
    private fun initChartUi() {
        ...
        if (dataThisCoin.rAW.uSD.cHANGEPCT24HOUR.toString().length >=6) {
            ...
            binding.layoutChart.txtChartChange2.text = dataThisCoin.rAW.uSD.cHANGEPCT24HOUR.toString() + "%"
        }
